    ...
    return (
        <>
            <div className="flex items-center justify-center relative mt-[25px] w-full">
                ...
                <Image onClick={() => setVideoOpen(true)} priority className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] h-[30%] duration-200 transition-all cursor-pointer hover:scale-110 hover:drop-shadow-2xl" unoptimized src="/images/elements/watch.svg" width={261} height={120} alt={watchAlt} />
                <Blur
                    color='#4A5DE5'
                    left="200px"
                    top="100px"
