        ...
        <div className={`px-[50px] py-[34px] border-solid border-[#6A65FF] ${className}`}>
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-[30px]">
                    ...
                    <h2 className={cn("font-medium text-[22px] text-white duration-300 transition-colors", { "text-[#6DB9FF]": isOpen })}>{question}</h2>
                </div>
            ...
            <div className="grid transition-[grid-template-rows] duration-300 ease-in-out"
                ...
                <p className="ml-[110px] font-normal text-[17.09px] text-[#E6E6E6] overflow-hidden">{answer}</p>
            </div>
        </div>
    )
}