        ...
        <div className="px-16 py-8 flex flex-col gap-[30px]">
            ...
            <div className="flex justify-between">
                <div className="flex flex-col gap-[10px]">
                    ...
                    <div className="w-fit max-w-[400px] max-medium:max-w-[300px] max-[700px]:max-w-[200px] truncate pt-[10px] pr-[14px] pb-[10px] pl-[14px] gap-[10px] rounded-[8px] bg-[#4A6ED1] font-normal text-[20px] max-smallest:text-[14px] leading-[30px] tracking-[-0.6%] text-[#FFFFFF]">{link}</div>
                </div>
