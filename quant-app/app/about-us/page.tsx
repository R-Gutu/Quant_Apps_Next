  ...
  return (
    <>
      <div className="about container">
        <div className="about-info">
          <div className="about-info-content">
            <Image className="about-info__img" src={AppPhone} alt="" />
      ...
      <section className="seo-section">
        <div className="container">
          <div className="seo">
            {/* <div className="seo__head">
                    ...
                    <div className="seo__avatar"><Image src="assets/images/autor.png" alt="" /></div>
        ...
        <Image src={Star} alt="" className="seo-bg-img seo-star-1" />
        <Image src={Star} alt="" className="seo-bg-img seo-star-2" />
        <Image src={Star} alt="" className="seo-bg-img seo-star-3" />
      </section>
